...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            youtubeLink: null,
            website: null,
            intervalMessages: ["teste 1", "teste 2"],
            messageInterval: 1,
            songstats: true,
            commandLiteral: "!",
            blacklists: {
        ...
        chatUtilities: {
            chatFilter: function (chat) {
                ...
                /** ((msg.indexOf(joinedroulette) > -1 || msg.indexOf(leftroulette) > -1) && chat.uid === basicBot.loggedInID) {
            ...
            spam: [
                'brbr', 'heu', 'brbr', 'spoder', 'mafia', 'aehoo', 'aheu', 'brazil', 'zoeira', 'fuckadmins', 'vaisefoder', 'huenaarea',
                'hitler', 'lulz', 'merda', 'pqp', 'puta', 'pula', 'retarda', 'caralho', 'filha', 'ppk',
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me Esse bot foi feito por ' + botCreator + '.');
                    }
                }
            },
